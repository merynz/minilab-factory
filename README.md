...
2. Clone a template using `tools/new-game.ps1`.
3. Add `MiniLab.Core` as local UPM dependency.
4. Fill `Games/<GameName>/store.yaml`.
5. Build Android using `tools/build-android.ps1`.
